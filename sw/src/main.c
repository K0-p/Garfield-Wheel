...
int main(void){
	...
	while(1){
		...
		if(int_val & 0x1){
			...
			a_y = (int)((readings[0] << 8)| readings[1]);
			...
			g_x = (int)((readings[0] << 8)| readings[1]);
			...
			g_y = (int)((readings[0] << 8)| readings[1]);
			ST7735_SetCursor(1, 2);
			ST7735_OutString("Gy = ");
			ST7735_SetCursor(5, 2);
			ST7735_sDecOut2(g_y);
			
			ReadBytes(0x68,GYRO_ZOUT_H, 2, readings);
			g_z = (int)((readings[0] << 8)| readings[1]);
